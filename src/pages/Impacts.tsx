...
class ImpactsRenderer extends React.Component {
    render = () => {
        return (
            <div>
                <div className="text-center text-4xl my-5 font-bold">Impacts</div>
                        ...
                        return (
                            <div className="flex justify-around grow basis-1 flex-wrap">
                                {impactPair.map(impact => {
                                    return (
                                        <div className="min-w-64 max-w-72 grow basis-1 border-2 border-dashed border-black p-5 rounded-3xl m-5 flex flex-col justify-around">
