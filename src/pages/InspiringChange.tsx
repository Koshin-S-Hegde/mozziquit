      ...
      <div className="my-10">
        ...
        <div className="flex justify-evenly text-justify flex-wrap flex-grow-1">
          <div className="min-w-4 max-w-[30rem]">
            <div className="border-dashed border-2 border-black p-10 py-5 w-fit rounded-3xl mt-5 shadow-lg shadow-gray-300 hover:shadow-lg hover:shadow-gray-700 hover:relative hover:bottom-1 hover:bg-white m-3">
              <div className="font-semibold text-3xl text-[#511]">
                Who we are?
              </div>
              ...
              <div className="mt-3 font-semibold text-3xl text-[#511]">
                What we do?
              </div>
              <div className="text-lg">
                MozziQuit is an innovative startup dedicated to eradicating mosquito-
          ...
          <div className="min-w-4 max-w-[30rem] flex flex-col justify-evenly">
            <div className="border-dashed border-2 border-black px-10 w-fit py-5 rounded-3xl mt-5 shadow-lg shadow-gray-300 hover:shadow-lg hover:shadow-gray-700 hover:relative hover:bottom-1 hover:bg-white m-3">
              <div className="font-semibold text-3xl text-[#511]">
                Vision
              </div>
              <div className="text-lg">
